...
import UserCard from '../components/cards.tsx'
...
import Stats from '../components/stats-zerotoone.tsx'
import Feature from '../components/zerotoone-details.tsx'
import Milestones from '../components/zerotooneweekly.tsx'
...
export default function Zerotoone () {
    return(
        ...
        <Heading as = "h3" fontSize={20} mb={4} mt={20}>
            Live Opportunities from Zero-to-One
            </Heading>
            ...
            <SimpleGrid columns={[1,1,3]} gap={6}>
                ...
                <Section>
                <StartupCards id="newtral" name="Newtral" des="Enterprise-grade SaaS platform helping organisations securely map, measure and reduce their carbon emissions." thumbsrc={newtralbg} ask="$80k" raised="80%" industry="Clean-tech" traction=" 2 B2B customers " tag={'Zero-to-one'} status="Live"> </StartupCards>
                </Section>
                <Section>
